                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <div className="form-group">
                            <label>Berat</label>
                            <input type="number" className="form-control" placeholder='Masukkan dalam satuan Kilogram' onChange={this.changeWeight} />
                        </div>
                        <div className="form-group">
                            <label>Tinggi</label>
                            <input type="number" className="form-control" placeholder='Masukkan dalam satuan meter' onChange={this.changeHeight} />
                        </div>
                        <div className="form-group">
